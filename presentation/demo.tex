...
\end{figure}
\begin{figure}[H]
 \includegraphics[width=0.7\linewidth]{figures/observational_coefplot_predicted.png}
\end{figure}
...
\begin{itemize}
  ...
  \item Binary and continuous variables rely on different approaches (IPW vs PLR).
